...
const sortBackwards = (arr) => {
  arr.sort(function(leftPotato, rightPotato){
    if(rightPotato > leftPotato){
      return 1;
    }else if(rightPotato < leftPotato){
      return -1;
    }else {
      return 0;
    }
...
const sortNumbersByLength = (arr) => {
  arr.sort(function(l,r){
    if(l.toString().length > r.toString().length){
      return 1;
    }else if(l.toString().length < r.toString().length){
      return -1;
    }else {
      return 0;
    }
...
const sortPeople = (arr) => {
  arr.sort(function(l,r){
    if(l.lastName.toLowerCase() > r.lastName.toLowerCase()){
      return 1;
    }else if(l.lastName.toLowerCase() < r.lastName.toLowerCase()){
      return -1;
    }else {
      return 0;
    }
...
const sortMeetingsByDay = (arr) => {
  const dict = {'Monday':1, 'Tuesday':2, 'Wednesday':3, 'Thursday':4, 'Friday':5};
  arr.sort(function(l,r){
    if(dict[l.dayOfWeek] > dict[r.dayOfWeek]){
      return 1;
    }else if(dict[l.dayOfWeek] < dict[r.dayOfWeek]){
      return -1;
    }else {
      return 0;
    }
  ...
  arr.sort(function(l,r){
    if(dict[l.dayOfWeek] > dict[r.dayOfWeek]){
      ...
      if(l.end - l.start > r.end - r.start){
        return 1;
      }else if(l.end - l.start < r.end - l.start){
        return -1;
      }else {
        return 0;
      }
